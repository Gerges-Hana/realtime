...
<body>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    <ul class="navbar-nav me-auto">
                        ...
                        {{-- <li class="dropdown dropdown-notification nav-item dropdown-notifications">
                            <a class="nav-link nav-link-label" href="#" data-toggle="dropdown">
                                <i class="fa fa-bell"></i>
                                <span class="text-danger badge badge-pill badge-default badge-danger badge-default badge-up badge-glow notif-count" data-count="9">9</span>
                            </a>
                            <ul class="dropdown-menu dropdown-menu-media dropdown-menu-right">
                                <li class="dropdown-menu-header">
                                    <h6 class="dropdown-header m-0 text-center">
    ...
    <script>
        ...
        var pusher = new Pusher('a7c32a4349d8ff103b67', {
            cluster: 'eu',
            encrypted: true,
        });
            ...
            <a href="#">
                <div class="media">
                    <div class="media-body">
                        ...
                        <p class="notification-text font-small-3 text-muted text-right">` + data.comments + `</p>
                        <small style="direction: ltr;">
                            <p class="text-muted text-right" style="direction: ltr;">` + data.date + ` - ` + data.time + `</p>
                        </small>
                    </div>
                </div>
            </a>
